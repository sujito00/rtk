...
* **wrangler:** add Cloudflare Wrangler CLI support (deploy, pages, dev) with ~70% token reduction
* **discover:** add wrangler to `rtk discover` registry
* **hooks:** add wrangler to `rtk-rewrite.sh` auto-rewrite hook
